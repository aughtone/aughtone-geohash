...
class CoverageLongsTest {
    ...
    fun testCoverageLongsHashLengthZero() {
        val coverage: CoverageLongs = CoverageLongs(longArrayOf(), 0, 1.0)
        assertEquals(0, coverage.hashLength)
    }

    @Test
    fun testCoverageLongsHashLengthNotZero() {
        val coverage: CoverageLongs = CoverageLongs(longArrayOf(100,200,300,400,500), 5, 1.0)
        assertEquals(4, coverage.hashLength)
    }

    @Test
    fun testToString() {
        val coverage: CoverageLongs = CoverageLongs(longArrayOf(1,2,3,4,5), 5, 1.0)
